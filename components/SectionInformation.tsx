    ...
    <section className="bg-custom-black-3 flex flex-col gap-y-10 py-10 md:py-16">
      ...
      <aside className="grid grid-cols-1 lg:grid-cols-3 w-10/12 mx-auto max-w-screen-xl gap-5 md:gap-10">
        {CARDS.map((card, idx) => (
          <div
            key={idx}
            className="rounded-lg flex flex-col gap-y-2 bg-custom-black-2 p-6 md:px-7 max-w-sm w-full mx-auto md:py-6 drop-shadow-white transition duration-300 ease-in-out hover:drop-shadow-green"
          >
